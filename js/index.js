            ...
            "children": [{
                ...
                for (i = 0; i < len; i++) {
                    ...
                    content += `<div class="card-deck">` +
                        ...
                        `<button type='button' id='myBtn' class='btn btn-outline-light' data-toggle='modal' data-target='#${cars.children[i].id}'>View Models</button></br></br>` +
                ...
                let modelsC = '';
                const ln = cars.children[0].children.length;
                for (i = 0; i < ln; i++) {
                    modelsC += `<div class='row'><div class='col-sm-6'>Models :</div><div class='col-sm-6'>${cars.children[0].children[i].name}</div></div>`+
                     `<div class='row'><div class='col-sm-6'>Price :</div><div class='col-sm-6'>${cars.children[0].children[i].price}</div></div>`;
                }
                ...
                function myFunction() {
                    let models = document.querySelector('div.modal-body');
                    models.innerHTML = modelsC;
